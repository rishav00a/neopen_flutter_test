...
public class PenClientCtrl implements IPenMsgListener
{
	...
	private Queue<PenClientCtrl.DotWithAddress> mDotQueueForBroadcast = null;
	/**
	...
	private PenClientCtrl( Context context )
	{
		...
		mDotQueueForBroadcast = new ConcurrentLinkedQueue<PenClientCtrl.DotWithAddress>();
...
//			enqueueDotForBroadcast(macAddress, dot);
	...
	private void enqueueDotForBroadcast(String macAddress, Dot dot){
		...
		mDotQueueForBroadcast.offer(new PenClientCtrl.DotWithAddress(macAddress ,dot));
