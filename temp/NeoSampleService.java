...
public class NeoSampleService extends Service {
    ...
    private void broadcastDot(String macAddress, Dot dot) {
        ...
        Intent intent = new Intent(hackathon.co.kr.neopen.temp.Const.Broadcast.ACTION_PEN_DOT);
        intent.putExtra(hackathon.co.kr.neopen.temp.Const.Broadcast.PEN_ADDRESS, macAddress);
        intent.putExtra(hackathon.co.kr.neopen.temp.Const.Broadcast.EXTRA_DOT, dot);
